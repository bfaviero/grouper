    ...
    var plotmap = function() {
        ...
        request.done(function (response, textStatus, jqXHR){
            ...
            for(var i=0;i<obj.length;i++) {
                ...
                var str="<a style='opacity:.9;' class='groupchatconnect' id='groupchatconnect' pinned="+obj[i].pinned+" groupid='"+obj[i]._id+"' href='#groupchat'>"+icon+" "+obj[i].name+"</a><span style='margin:0px; display:inline; float:right; margin-top:-10px !important;' id='timeinchat' class='ui-li-count ui-btn-up-c ui-btn-corner-all'>"+(obj[i].dist).toFixed(2)+" mi</span>";
